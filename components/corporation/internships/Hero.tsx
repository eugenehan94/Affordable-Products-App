...
const Hero = () => {
  return (
    <section className="mt-24 bg-yellow-400">
      <div className="p-5 pt-12 md:flex md:p-8 md:pt-14">
        <div className="md:basis-1/2 md:p-1">
          <div className="mb-5">
            <h2 className="uppercase text-violet-600 text-lg md:text-xl lg:text-2xl font-bold">
              OUR TEAMS
            </h2>
          </div>
          <div className="mb-5">
        ...
        <div className="md:basis-1/2 relative">
          <Image
            src="/CorporationInternshipsHeroImage.jpg"
            alt="Hero"
            width={500}
            height={500}
